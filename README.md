...
/set-codex-model gpt-5.2-codex         # 既定モデルを保存
```
...
```bash
# bash
bash scripts/codex-wrapper.sh --set-model gpt-5.2-codex
bash scripts/codex-wrapper.sh --show-model

# PowerShell
powershell -File scripts/codex-wrapper.ps1 -SetModel gpt-5.2-codex
